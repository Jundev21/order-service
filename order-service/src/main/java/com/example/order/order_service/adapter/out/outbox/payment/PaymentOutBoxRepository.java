...
@Repository
public interface PaymentOutBoxRepository extends JpaRepository<PaymentOutboxEventEntity,Long> {
    //만약 pending 이 1000만건처럼 대량으로 있다고 가정하면 한번에 다 읽기보다는 100개씩 끊어서 조회
    List<PaymentOutboxEventEntity> findTop100ByStatusOrderByIdAsc( OutboxStatus status );
}